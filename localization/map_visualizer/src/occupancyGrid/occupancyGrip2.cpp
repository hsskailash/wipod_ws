...
public:
    OccupancyGridPublisher() : Node("occupancy_grid_publisher") {
        ...
        occupancy_grid_publisher_ = this->create_publisher<nav_msgs::msg::OccupancyGrid>("occupancy_grid", rclcpp::QoS(rclcpp::QoSInitialization::from_rmw(rmw_qos_profile_default))
